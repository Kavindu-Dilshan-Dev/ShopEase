...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public ProductAdapter(Context context, List<Product> products, OnCartClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.tvPrice.setText(String.format("LKR %.2f", product.getPrice()));
        ...
        if (product.isOnSale()) {
            ...
            holder.tvDiscount.setText(String.format("-%.0f%%",
                    (1 - product.getDiscountPrice() / product.getPrice()) * 100));
        }
